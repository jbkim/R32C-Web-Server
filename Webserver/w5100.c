...
#define W5100_DELAY_TIMING	0x01

// port
#define W5100_P_MOSI			p7_0
#define W5100_P_MISO			p7_1
#define W5100_P_SCLK			p7_2
#define W5100_P_SCS				p7_3
//#define W5100_P_RESET			p7_6
#define W5100_P_RESET			p3_0

// direction
#define W5100_D_MOSI			pd7_0
#define W5100_D_MISO			pd7_1
#define W5100_D_SCLK			pd7_2
#define W5100_D_SCS				pd7_3
//#define W5100_D_RESET			pd7_6
#define W5100_D_RESET			pd3_0
...
void uart_tx( register char c )
{
	...
	u2tb = c; // write the character to tx buffer
}
...
void W5100_Delay(unsigned long int units)
{
	unsigned long counter = units * W5100_DELAY_TIMING;
...
void 	IINCHIP_SpiInit(void)
{

#ifndef USE_PORT_IO

	// GPIOs
	//pur1 = pur0 = 0xFF; //pur2 = // enable pull-ups on all ports
	pu22=1;
	p7 = 0xFF; // P73(CHIP_SELECT) & P72/CLK2 are high
	pd7_1 = 0;
	pd7_3 = pd7_2 = pd7_0 = 1; // P73, P72/CLK2, P70/TXD2 are outputs
	p7_0s = 0x03;
	p7_2s = 0x03;
	...
	u2c0 = 0x91; // msb first, CKPOL=0, no CTS/RTS, clock is f1  10010001	
	u2c1 = 0x00; // no data reverse, rx & tx disabled   0000
	u2brg = 1; // 
	
	u2smr =0;
	u2smr2 = 0;
	u2smr3 = 0x02; //00000011
	u2smr4 = 0;
	
#endif
}

void IINCHIP_SpiSendData(uint8 val)
{
...
uint8 IINCHIP_SpiRecvData(void)
{
	uint8 status = 0;
...
*/ 
void setSUBR(uint8 * addr)				// a pointer to a 4-byte array responsible to set the SubnetMask address
{
