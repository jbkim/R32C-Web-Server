...
extern unsigned char IINCHIP_READ(uint16 addr);
...
extern void W5100_Delay(unsigned long int units);
extern void W5100_Reset(void);
extern void SET_SCS(uint8 val);

extern void IINCHIP_SpiSendData(uint8 val);
extern uint8 IINCHIP_SpiRecvData(void);
extern void IINCHIP_SpiInit(void);
